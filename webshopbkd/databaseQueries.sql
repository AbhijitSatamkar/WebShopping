...
VALUES ('Abhi', 'S', 'ADMIN', true, 'admin', 'abhi@gmail.com', '8888888888');

INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Sne', 'P', 'SUPPLIER', true, '12345', 'sne@gmail.com', '9999999999');

INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Sneh', 'S', 'SUPPLIER', true, '12345', 'Sneh@gmail.com', '7777777777');
